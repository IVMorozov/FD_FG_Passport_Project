$(document).ready(function() {
	...
	let scale_KFD_mass = [
		    {Level: '00', color: "#d91600", mark: 10,},
			{Level: '01', color: "#d301000", mark: 20,},
		...
		let KFD_data_mass = [
			{loc: 'Volgograd', mark: 95, color: "",},
			{loc: 'Gorodishensky', mark: 45, color: "",},
	...
	but_1.onclick = function() {	
		$('.footer_').fadeOut();
		// var paths = document.getElementsByClassName('part');
		// 	console.log(paths.length)
		// 	for (i = 0; i < paths.length; i++) {
		// 		paths[i].style.opcity="0,3";
		// 	}
		// var paths = document.getElementsByClassName('city');
		// 	console.log(paths.length)
		// 	for (i = 0; i < paths.length; i++) {
		// 		paths[i].style.opcity="0,6";
		// 	}	
	...
	but_2.onclick = function() {
		...
		// const color_Control = document.getElementsByClassName('part')
		// color_Control.setProperty("opacity", 0,5);
		// var paths = document.getElementsByClassName('part');
		// 	console.log(paths.length)
		// 	for (i = 0; i < paths.length; i++) {
		// 		paths[i].style.opcity="1";
		// 	}
